...
--
-- Host: localhost:3306
-- Gegenereerd op: 21 dec 2022 om 12:16
-- Serverversie: 10.3.37-MariaDB-0ubuntu0.20.04.1
-- PHP-versie: 7.4.3
...
CREATE DATABASE IF NOT EXISTS `w3schools` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `w3schools`;
...
(63, 'QUICK-Stop', 'Horst Kloss', 'Taucherstraße 10', 'Cunewalde', NULL, 'Germany'),
(64, 'Rancho Grande 2nd', 'Sergio Gutiérrez', 'Av. del Libertador 900', 'Buenos Aires', '1010', 'Argentina'),
...
(91, 'Wolski', 'Zbyszek', 'ul. Filtrowa 68', 'Walla', NULL, 'Poland');
...
--
-- Stand-in structuur voor view `jaar`
...
--
-- Tabelstructuur voor tabel `Shippers`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `Shippers`
--
...
--
-- Tabelstructuur voor tabel `temp_customer`
--

CREATE TABLE `temp_customer` (
  `CustomerName1` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CustomerName2` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `City` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Gegevens worden geëxporteerd voor tabel `temp_customer`
--

INSERT INTO `temp_customer` (`CustomerName1`, `CustomerName2`, `City`) VALUES
...
--
-- Stand-in structuur voor view `v_customers`
-- (Zie onder voor de actuele view)
--
...
--
-- Structuur voor de view `jaar`
--
DROP TABLE IF EXISTS `jaar`;

CREATE ALGORITHM=UNDEFINED DEFINER=`sql-basis`@`%` SQL SECURITY DEFINER VIEW `jaar`  AS  select 1 AS `id`,'Januari' AS `Month` union select 2 AS `2`,'Februari' AS `Februari` ;

-- --------------------------------------------------------

--
-- Structuur voor de view `v_customers`
--
DROP TABLE IF EXISTS `v_customers`;

CREATE ALGORITHM=UNDEFINED DEFINER=`sql-eu`@`localhost` SQL SECURITY DEFINER VIEW `v_customers`  AS  select `A`.`CustomerName` AS `CustomerName1`,`B`.`CustomerName` AS `CustomerName2`,`A`.`City` AS `City` from (`Customers` `A` join `Customers` `B`) where `A`.`CustomerID` <> `B`.`CustomerID` and `A`.`City` = `B`.`City` order by `A`.`City` ;
...
--
-- AUTO_INCREMENT voor een tabel `Shippers`
--
ALTER TABLE `Shippers`
